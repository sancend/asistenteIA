...
with right_col:
        ...
        fig.add_trace(
            go.Scattermapbox(
                ...
                marker=go.scattermapbox.Marker(
                    size=24,
                    color="blue",  # Cambia el color de los marcadores a azul
                ),
    ...
    fig.update_layout(
        ...
        mapbox=dict(
            ...
            pitch=0,
            zoom=10,  # Ajusta el zoom inicial a 10
            style="satellite-streets",  # Cambia el estilo del mapa a 'satellite-streets'
        ),
        height=600,
    )
    st.plotly_chart(
...
st.chat_input(
    placeholder="Ingresa la instrucción aquí",
